...
console.log("a. Display all restaurants' names");
// a. Display all restaurants' names
const restaurantNames = restaurants.map(restaurant => restaurant.name);
console.log("Restaurant Names:", restaurantNames);
console.log("Display the operating hours of restaurant id:4");
// b. Display the operating hours of restaurant id:4
const restaurantId4 = restaurants.find(restaurant => restaurant.id === 4);
console.log("Operating Hours of Restaurant id:4", restaurantId4.operating_hours);
console.log("c. Display the comments provided by customer Steph for restaurant Emily");
// c. Display the comments provided by customer Steph for restaurant Emily
const emilyRestaurant = restaurants.find(restaurant => restaurant.name === "Emily");
const stephComment = emilyRestaurant.reviews.find(review => review.name === "Steph");
console.log("Comments by Steph for Restaurant Emily:", stephComment.comments);
console.log("d. Display all restaurants' names whose cuisine_type is Asian");
// d. Display all restaurants' names whose cuisine_type is Asian
const asianRestaurants = restaurants.filter(restaurant => restaurant.cuisine_type === "Asian");
const asianRestaurantNames = asianRestaurants.map(restaurant => restaurant.name);
console.log("Asian Cuisine Restaurants:", asianRestaurantNames);
console.log("e. Display all restaurants whose neighborhood is Brooklyn");
// e. Display all restaurants whose neighborhood is Brooklyn
const brooklynRestaurants = restaurants.filter(restaurant => restaurant.neighborhood === "Brooklyn");
console.log("Restaurants in Brooklyn:", brooklynRestaurants);
